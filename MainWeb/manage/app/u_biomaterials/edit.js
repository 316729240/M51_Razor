$M.u_biomaterials.edit = function (S) {
    ...
    var form=tab.addControl({
        xtype: "Form",
        command: "u_biomaterials.ajax.edit",
        templateUrl: $M.config.appPath + "u_biomaterials/edit.html",
        ...
        onLoad: function (sender) {
            ...
            sender.read("u_biomaterials.ajax.read", S.dataId, function (json) {
                sender.val(json);
            });
        }
    });
