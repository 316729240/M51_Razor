$M.u_clinicalCase.edit = function (S) {
    var tab = mainTab.addItem({ text: "临床病例", "class": "form-horizontal", closeButton: true });
    tab.focus();
    ...
    var form=tab.addControl({
        xtype: "Form",
        command: "u_clinicalCase.ajax.edit",
        templateUrl: $M.config.appPath + "u_clinicalCase/edit.html",
        ...
        onLoad: function (sender) {
            ...
            sender.read("u_clinicalCase.ajax.read", S.dataId, function (json) {
                sender.val(json);
            });
        }
    });
