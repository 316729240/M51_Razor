$M.system.insertPic = function (S) {
    ...
    var uploadFile = function () {
        ...
        xhr.open("POST", $M.config.appPath + "system/upload.ashx");
        xhr.send(fd);
    }
    var inputFile = $("<input type='file' accept='image/png,image/gif,image/jpg'  multiple='multiple' style='display:none' >").appendTo($(document.body));
