...
$M.templateManage.viewEdit = function (S) {
    if ($M._templateManage_edit) {
        ...
        tree.root.addItem([{ ico: "fa-folder-o", text: "网站变量", type: 1 }, { ico: "fa-folder-o", text: "自定义标签", type: 3 }, { ico: "fa-folder-o", text: "自定义视图", type: 4}]);
        $M.comm([
                ...
                ["templateManage.ajax.readView", { id: S.id}]
                    ...
                    tree.root.items[1].addItem([{ ico: "fa-cube", text: "自定义数据标签", type: 32 }, { ico: "fa-cube", text: "Sql查询标签", type: 33}]);
                    if (S.id != null) {
